...
GameState.Play.prototype = {
    create: function () {
        ...
        this.label_lvl = this.game.add.text(0, - plataille, (Stats.level + 1), { font: '30px Arial', fill: '#'+bleu, align: 'center' }, this.general);
        this.label_lvl.anchor.setTo(0.5, 0.5);
        this.label_score = this.game.add.text(0, + plataille, Stats.score, { font: '20px Arial', fill: '#'+bleu, align: 'center' }, this.general);
    ...
    update: function() {
        ...
        // Sur la planete
        /*var collid = */this.game.physics.arcade.collide(this.dude, this.plnte);
        // Sur la plateforme
        /*var onPlt = */this.game.physics.arcade.collide(this.dude, this.plateformes);
    ...
    takeEtoiles: function(dude, etoile) {
        ...
        /* */ t.onComplete.add(function(){this.kill();}, etoile);
